...
__all__ = ['MDTv2', 'MDTv2_B_2', 'MDTv2_L_2', 'MDTv2_XL_2', 'MDTv2_S_2', 'MDTv2_B_4', 'MDTv2_L_4', 'MDTv2_XL_4', 'MDTv2_S_4']
...
class MDTv2(nn.Module):
    ...
    def __init__(
        ...
        self.to_pixel = ToPixel(to_pixel='none', img_size=input_size, out_channels=self.out_channels, in_dim=hidden_size, patch_size=patch_size)
...
def MDTv2_S_2(**kwargs):
    return MDTv2(depth=12, hidden_size=384, patch_size=2, num_heads=6, decode_layer=6, **kwargs)



def MDTv2_XL_4(**kwargs):
    return MDTv2(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)

def MDTv2_L_4(**kwargs):
    return MDTv2(depth=24, hidden_size=1024, patch_size=4, num_heads=16, **kwargs)

def MDTv2_B_4(**kwargs):
    return MDTv2(depth=12, hidden_size=768, patch_size=4, num_heads=12, decode_layer=2, **kwargs)

def MDTv2_S_4(**kwargs):
    return MDTv2(depth=12, hidden_size=384, patch_size=4, num_heads=6, decode_layer=6, **kwargs)