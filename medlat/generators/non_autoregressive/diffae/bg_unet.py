...
from .bg_blocks import *

from .bg_nn import (conv_nd, linear, normalization, timestep_embedding,
...
class BeatGANsUNetModel(nn.Module):
    def __init__(self, conf):
        ...
        for level, mult in enumerate(conf.input_channel_mult
            ...
            if level != len(conf.channel_mult) - 1:
                if level == conf.where_to_concat_seg_cond:#CHANGED ARIST
                    out_ch=ch
    ...
    def forward(self, x, t, y=None, seg_style=None, **kwargs):
        """
