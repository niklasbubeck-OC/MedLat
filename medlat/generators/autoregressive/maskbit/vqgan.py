...
from .util.quantizer_utils import entropy_loss_fn
...
class ConvVQModel(BaseModel):
    def __init__(
        ...
        Args:
            ...
            ckpt_path -> Optional[str]: The path to the checkpoint to load the model from.
        """
        super().__init__()
        ...
        if ckpt_path:
            ...
            print(f"Loaded VQ model pretrained from {ckpt_path}")
