...
class TiTokEncoder(nn.Module):
    ...
    def forward(self, pixel_values, latent_tokens):
        print(f"pixel_values.shape: {pixel_values.shape}, latent_tokens.shape: {latent_tokens.shape}")
        ...
        print(f"x.shape: {x.shape}, self.class_embedding.shape: {self.class_embedding.shape}, self.positional_embedding.shape: {self.positional_embedding.shape}")
